...
public class Bonificacion extends Actor
{
    ...
    /**
     * Incrementa una vida si atrapa el objeto Vida.
     */
    public void incrementVida()
    {
        World mundo = getWorld();
        Mar myWorld = (Mar)mundo;
        myWorld.getJugador().incrementVida();
        int x = myWorld.getJugador().getVida();
        myWorld.getVidaCunter().setValue(x);
    }
    
    /**
     * incrementa la puntuacion(score) si atrapa el objeto Punto.
     */
    public void incrementBonus()
    {
        World mundo = getWorld();
        Mar myWorld = (Mar)mundo;
        myWorld.getJugador().incrementBonus();
